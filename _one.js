...
let urls = [];
let subConverter = "subapi.lbyan.pp.ua"; //在线订阅转换后端，目前使用CM的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
			...
			<html>
                ...
                <body>
                    ...
                    <div class="container">
                        <div class="header">
                            <h1>订阅地址</h1>
                            <p>点击链接自动复制订阅链接并生成二维码</p>
                        </div>
                        <div class="subscription-grid">
                            <div class="subscription-card">
                                <div class="subscription-title">自适应订阅地址</div>
                                <a href="javascript:void(0)" class="subscription-link" onclick="copyToClipboard('https://${url.hostname}/${mytoken}?sub','qrcode_0')">https://${url.hostname}/${mytoken}</a>
                                <div class="qrcode-container">
                                    <div id="qrcode_0"></div>
                                </div>
                            </div>
                            <div class="subscription-card">
                                <div class="subscription-title">Base64订阅地址</div>
                                <a href="javascript:void(0)" class="subscription-link" onclick="copyToClipboard('https://${url.hostname}/${mytoken}?b64','qrcode_1')">https://${url.hostname}/${mytoken}?b64</a>
                                <div class="qrcode-container">
                                    <div id="qrcode_1"></div>
                                </div>
                            </div>
                            <div class="subscription-card">
                                <div class="subscription-title">Clash订阅地址</div>
                                <a href="javascript:void(0)" class="subscription-link" onclick="copyToClipboard('https://${url.hostname}/${mytoken}?clash','qrcode_2')">https://${url.hostname}/${mytoken}?clash</a>
                                <div class="qrcode-container">
                                    <div id="qrcode_2"></div>
                                </div>
                            </div>
                            <div class="subscription-card">
                                <div class="subscription-title">Singbox订阅地址</div>
                                <a href="javascript:void(0)" class="subscription-link" onclick="copyToClipboard('https://${url.hostname}/${mytoken}?sb','qrcode_3')">https://${url.hostname}/${mytoken}?sb</a>
                                <div class="qrcode-container">
                                    <div id="qrcode_3"></div>
                                </div>
                            </div>
                            <div class="subscription-card">
                                <div class="subscription-title">Surge订阅地址</div>
                                <a href="javascript:void(0)" class="subscription-link" onclick="copyToClipboard('https://${url.hostname}/${mytoken}?surge','qrcode_4')">https://${url.hostname}/${mytoken}?surge</a>
                                <div class="qrcode-container">
                                    <div id="qrcode_4"></div>
                                </div>
                            </div>
                            <div class="subscription-card">
                                <div class="subscription-title">Loon订阅地址</div>
                                <a href="javascript:void(0)" class="subscription-link" onclick="copyToClipboard('https://${url.hostname}/${mytoken}?loon','qrcode_5')">https://${url.hostname}/${mytoken}?loon</a>
                                <div class="qrcode-container">
                                    <div id="qrcode_5"></div>
                                </div>
                            </div>
